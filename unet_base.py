...
class Unet(nn.Module):
    ...
    def __init__(self, im_channels, model_config):
        ...
        self.feature_out = model_config['feature_out']
    ...
    def forward(self, x, t):
        ...
        intermediate_out_down = out.clone()
        
        for mid in self.mids:
            out = mid(out, t_emb)
        # out B x C3 x H/4 x W/4
        intermediate_out_mid = out.clone()
        for up in self.ups:
        ...
        if self.feature_out:
            return (out, intermediate_out_down, intermediate_out_mid)
